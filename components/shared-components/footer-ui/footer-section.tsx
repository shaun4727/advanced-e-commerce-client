                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-blue-100">
                                Get the latest updates on new products and
                                upcoming sales
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div className="text-sm leading-relaxed">
                                    <p>
                                        {
                                            footerSections.contactUs.content
                                                .address.line1
                                        }
                                    </p>
                                    <p>
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            {footerSections.customerService.links.map(
                                (link, index) => (
                                    <li key={index}>
                                        <Link
                                            href={link.href}
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            {footerSections.corporation.links.map(
                                (link, index) => (
                                    <li key={index}>
                                        <Link
                                            href={link.href}
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-3">
                            {footerSections.whyChooseUs.links.map(
                                (link, index) => (
                                    <li key={index}>
                                        <Link
                                            href={link.href}
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0">
                    ...
                    <div className="text-center lg:text-right">
                        <p className="text-sm text-gray-400">
                            © {new Date().getFullYear()} Flipmart. All rights
                            reserved.
                        </p>
