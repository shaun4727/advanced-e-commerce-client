...
export const NavBar = () => {
    return (
        <header>
            ...
            {/* <div className="bg-blue-700 px-2 flex flex-col justify-center items-center  gap-4 py-4">
                <div className="flex items-center">
                    <h1 className="text-md text-2xl font-bold text-yellow-400 ">
                        Emart
                    </h1>
                </div>
                ...
                <div className=" max-w-2xl mx-8">
                    <div className="flex justify-center h-11">
                        ...
                        <Input
                            placeholder="Search here..."
                            onBlur={() => {}}
                            className="bg-white w-48 md:w-full h-full rounded-r-none text-black"
                        />
                        <Button
                            onClick={() => {}}
                            className=" bg-yellow-500 hover:bg-yellow-600 text-black rounded-l-none px-6 h-full btn-default"
                            aria-label="Search"
                        >
                            <Search className="h-4 w-4" />
                        </Button>
                ...
                <div className="flex items-center space-x-2 bg-blue-600 flex-row px-4 py-2 rounded cursor-pointer">
                    <Link
                        href="/cart"
                        className="flex items-center p-2 flex-row gap-2"
                    >
