...
import { IBrand, ICategory, productSchema } from '@/types';
...
export default function AddProductsForm() {
    ...
    const form = useForm({
        resolver: zodResolver(productSchema), // Add this line
        defaultValues: {
            name: '',
            description: '',
            price: '',
    ...
    return (
        <div className="border-2 border-gray-300 rounded-xl basis-5xl max-w-2xl p-5 ">
