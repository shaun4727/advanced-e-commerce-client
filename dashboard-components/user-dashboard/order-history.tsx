...
import InvoiceGenerator from '@/components/order-history/invoice-template';
import {
    Drawer,
    DrawerContent,
    DrawerFooter,
                            ...
                            <div className="p-4 pb-0">
                                ...
                                <div className="mb-6">
                                    <p className="text-sm sm:text-base text-gray-600">
                                        Lets boost your sales with powerful
                                        insights and effective strategies today
                                    </p>
                                </div>
